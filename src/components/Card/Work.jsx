  ...
  return (
    <div className=" bg-transparent container mx-auto px-4 text-center rounded-lg p-8 text-white">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="flex flex-col items-center justify-center mt-6 transform transition-transform duration-300 ease-in-out hover:scale-105">
        ...
        <div className="flex flex-col items-center justify-center transform transition-transform duration-300 ease-in-out hover:scale-105">
