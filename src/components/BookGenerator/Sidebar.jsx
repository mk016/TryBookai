...
const Sidebar = ({ onGenerate }) => {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        console.log('Submitting from Sidebar:', bookDetails);
        
        if (!bookDetails.topic || !bookDetails.genre || !bookDetails.language) {
            alert('Please fill in all required fields (Topic, Genre, and Language)');
            return;
        }
        ...
        const dataToSend = {
            ...
            wordCount: parseInt(bookDetails.wordCount),
        ...
        console.log('Clean data being sent:', dataToSend);
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="space-y-2">
                        ...
                        <input
                            ...
                            className={`w-full p-3 bg-gray-900/50 rounded-lg border ${
                                !bookDetails.topic ? 'border-red-500' : 'border-gray-700'
                    ...
                    <div className="space-y-2">
                        ...
                        <select
                            ...
                            onChange={handleChange}
                            className={`w-full p-3 bg-gray-900/50 rounded-lg border ${
                                !bookDetails.language ? 'border-red-500' : 'border-gray-700'
                            }`}
                            required
                        >
                            {languages.map(lang => (
